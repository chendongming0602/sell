...
export default {
    ...
    methods:{
        ...
        dateEvent(){
            let time1=new Date();
            let xuantime1=time1.getMonth()+1+"-"+time1.getDate();
            let xuantime2=new Date(time1.getTime()+86400000);
            xuantime2=xuantime2.getMonth()+1+"-"+xuantime2.getDate();
            this.xuantime1=xuantime1;
            this.xuantime2=xuantime2;
        }
